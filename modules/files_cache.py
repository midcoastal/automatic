...
class DirectoryWalker():
    def __init__(self, directory):
        ...
        self.thread.start()
        if directory.path in walked_already:
            log.debug(f'Re-Walking {directory.path} ({active_count()} active theads)')
        walked_already.add(directory.path)
